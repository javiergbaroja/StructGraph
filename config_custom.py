...
class Config(object):
    ...
    def __init__(self, args):
        ...
        if "cv0" in args.train_file:
            class_weights = cv0_weights
        elif "cv1" in args.train_file:
            class_weights = cv1_weights
        elif "cv2" in args.train_file:
            class_weights = cv2_weights
        else:
            class_weights = [1 for __ in range(args.nr_type-1)]
