...
def process(pred_map,pred_inst,nr_types=None, return_centroids=True):
    ...
    #cv2.imwrite('pred_type.png', pred_type)
    #cv2.imwrite('pred_inst.png', pred_inst)
    inst_info_dict = None
    ...
    if nr_types is not None:
        ...
        for inst_id in list(inst_info_dict.keys()):
            ...
            #print(inst_id,inst_type_crop.max())
...
class InferManager(base.InferManager):
    ...
    def process_file_list(self, run_args):
        ...
        while len(file_path_list) > 0:
            ...
            use_inst_path_list = []
            mat_files = os.listdir(self.inst_dir)
            while len(file_path_list) > 0:
                ...
                # if file_idx == 4: break
                    ...
                    use_inst_path_list.append(inst_path)
